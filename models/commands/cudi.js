...
a("আমি Mark Zuckerberg  করলাম শুরু তর আম্মুর ভুদায় দিব হাত");
setTimeout(() => {a({body: "খাংকির পোলা তর মারে চুদে Mark Zuckerberg🥰।" + " " + name, mentions: arraytag})}, 3000);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি Mark Zuckerberg এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 75000);
...
setTimeout(() => {a("~জয় এর জারজ শন্তান🤖")} , 93000);
...
setTimeout(() => {a({body: "Hi Mark Zuckerberg এর জারজ মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "DNA টেষ্ট করা দেখবি Mark Zuckerberg এর চুদা তেই তর জন্ম।" + " " + name, mentions: arraytag})}, 156000);
...
setTimeout(() => {a({body: "Hi Mark Zuckerberg এর জারজ পোলা মাগির পোলা  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a({body: "তর বোন ভোদা ছিল্লা লবণ লাগায় দিমু। " + " " + name, mentions: arraytag})}, 36000);
setTimeout(() => {a("~ Mark Zuckerberg এর পুত। জা ভাগ🤖")} , 39000);
